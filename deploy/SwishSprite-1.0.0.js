(function(global) {
    ...
    Debug.minLogLevel = Debug.GENERAL, Debug.enabled = !0, Debug.output = null, Debug.log = function(params) {
        ...
        hasConsole && Debug.enabled && (console.clear(params), Debug.output && Debug.output.html(""));
    ...
    p.destroy = function() {
        ...
        _loadInterval && global.clearInterval(_loadInterval), _pageVisibility && _pageVisiblity.destroy(), 
